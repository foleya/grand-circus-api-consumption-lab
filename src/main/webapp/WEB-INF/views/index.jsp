...
<title>Abbreviated Computer Science Hall of Fame</title>
		...
		<div class="card">
  			...
  			<div class="card-body">
    			<table class="table">
					<thead>
						<tr>
							<th style="width: 20%">Name</th><th style="width: 70%">Invention</th><th style="width: 10%">Year</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="coolPerson" items="${hof}">
							<tr>
								<td>${coolPerson.name}</td><td>${coolPerson.invented}</td><td>${coolPerson.year}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
    			<a href="/complete-hof" class="btn btn-primary">See Complete List</a>
  			</div>
		</div>
